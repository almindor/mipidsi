...
/// ILI9341 display in Rgb888 color mode.
...
impl Model for ILI9341Rgb888 {
    ...
    where
        ...
        I: IntoIterator<Item = Self::ColorFormat>,
    {
        ili934x::write_pixels_rgb888(dcs, colors)
    }
...
impl<DI> Builder<DI, ILI9341Rgb888>
where
    DI: WriteOnlyDataCommand,
{
    /// Creates a new display builder for an ILI9341 display in Rgb565 color mode.
    ...
    /// * `di` - a [display interface](WriteOnlyDataCommand) for communicating with the display
    ///
    pub fn ili9341_rgb888(di: DI) -> Self {
        Self::with_model(di, ILI9341Rgb888)
    }
}

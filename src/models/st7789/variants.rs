...
use crate::{DisplayBuilder, ModelOptions, Orientation, WindowOffsetResult};
...
pub(crate) fn pico1_offset(options: &ModelOptions) -> WindowOffsetResult {
    let result = match options.orientation() {
